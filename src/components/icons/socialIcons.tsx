...
export function getSocialIcon(platform: string): SocialIconComponent | null {
  const key = platform.trim().toLowerCase()

  for (const [name, icon] of Object.entries(socialIconMap)) {
...
export function SocialIcon({
  ...
  return <Icon className={className ? `site-icon ${className}` : 'site-icon'} height={size} width={size} />
}
